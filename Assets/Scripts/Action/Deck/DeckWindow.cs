...
public class DeckWindow : MonoBehaviour, IDropHandler
{
    ...
    private const int row = 5, headHeight = 260, commandWidth = 70, padding = 10;
    ...
    private void SetWindowSize()
    {
        ...
        GetComponent<RectTransform>().sizeDelta = new Vector2(commandWidth * row + 30, commandWidth * column + headHeight);
    }
